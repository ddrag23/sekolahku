...
class M_ppdb extends CI_Model
{
    ...
    {
        $query = $this->db->query('SELECT DATE(date_created) as tanggal, COUNT(id_ppdb) as jumlah_data FROM ppdb GROUP BY DAY(date_created) ORDER BY DAY(date_created) LIMIT 10');
        return $query;
    }
