...
class Welcome extends CI_Controller
{
  ...
  public function alumni()
  {
    ...
    $query = $this->db->get_where('siswa', ['status' => 'alumni'], $config['per_page'], $from)->result();
  ...
  public function getSiswaAktifJson()
  {
    $keyword = $this->input->get('keyword');
    $data = $this->m_siswa->searchAktif($keyword);
    echo json_encode($data);
  }
  public function getSiswaAlumniJson()
  {
    $keyword = $this->input->get('keyword');
    $data = $this->m_siswa->searchAlumni($keyword);
    echo json_encode($data);
  }
  ...
  public function dataSiswa()
  {
    ...
    $from = $this->uri->segment(3);
    $this->pagination->initialize($config);
    $query = $this->db->where('status', 'aktif')->get('siswa', $config['per_page'], $from)->result();
