		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content col-lg-8">
				<div class="title text-center">
					<h1>Data Alumni</h1>
					<p>Data Alumni di MI Hasyim Asy'ari</p>
				</div>
			</div>
			<div class="col-md-12">
				<form action="<?= site_url('welcome/alumni');?>" method="get">
		        <div class="input-group mb-3">
		        <input type="text" name="keyword" id="keyword" class="form-control" placeholder="Cari Siswa" autocomplete="off">
		        <div class="input-group-append">
		        <a href="<?= site_url('welcome/alumni');?>" class="btn btn-success"><i class="fa fa-refresh"></i> Refresh </a>
            <button type="submit" name="search" class="btn btn-secondary" id="search" style="border-radius: 0 50px 50px 0;"><i class="fa fa-search"></i> Cari</button>
            <div>
		        </div>
		      </form>				
			</div>
