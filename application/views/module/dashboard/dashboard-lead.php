     ...
     <!-- page content -->
      <div class="right_col" role="main">
        ...
        <div class="tile-stats">
          ...
          <h3>Admin</h3>
          <p>
          <a href="<?= site_url('halaman/pengguna/admin');?>">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
         </p>
        </div>
      </div>
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
        <div class="tile-stats">
          ...
          <h3>Panitia</h3>
          <p>
          <a href="<?= site_url('halaman/pengguna/panitia');?>">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
          </p>
        </div>
      </div>
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
        <div class="tile-stats">
          ...
          <h3>Guru</h3>
          <p>
          <a href="<?= site_url('halaman/guru');?>">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
          </p>
        </div>
      </div>
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
