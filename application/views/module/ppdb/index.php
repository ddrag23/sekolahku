...
<div class="right_col" role="main">
        <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12" >
          ...
          <h2><strong> Dashboard PPDB</strong></h2>
          <h3></h3>
           </div>
        </div>
        ...
        <div class="tile-stats">
          ...
          <div class="count"><?= $pendaftar ?></div>
          <h3>Pendaftar</h3>
          <p>
          <a href="#barPerhari">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
         </p>
        </div>
      </div>
      <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
        <div class="tile-stats">
          <div class="icon"><i class="fa fa-user"></i></div>
          <div class="count"><?= $gelombang1; ?></div>
          <h3>Sesi Gelombang</h3>
          <p>
          <a href="#barGelombang">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
         </p>
        </div>
      </div>
        <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
        <div class="tile-stats">
          ...
          <h3>Seleksi</h3>
          <p>
          <a href="#barSeleksi">Lihat Selengkapnya <i class="fa fa-arrow-right"></i></a>
         </p>
        </div>
      </div>
       <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
